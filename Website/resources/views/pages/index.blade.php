...
<div class="container">
  <div class="row content">
    ...
    <div class="col-sm-9">
    	<span class="glyphicon glyphicon-user"></span><span style="font-size: 20px;">@if(!Auth::guest()) {{ Auth::user()->name }} @else ADMIN_NAME @endif</span><p class="pull-right" id="demo" style="color: green"></p>
    	<script>
		var d = new Date();
